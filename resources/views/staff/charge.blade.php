...
.section-label{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.35);margin:20px 0 12px;padding-top:16px;border-top:1px solid rgba(255,255,255,.06)}
...
.saved-till-info span{font-size:11px;color:rgba(255,255,255,.4);margin-top:2px;display:block}
.change-btn{font-size:12px;color:rgba(255,255,255,.35);background:none;border:none;cursor:pointer;text-decoration:underline}
...
.preview-row .lbl{color:rgba(255,255,255,.45)}
