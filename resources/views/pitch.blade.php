...
<title>Pregota Collections â€” Investor Deck</title>
<meta property="og:title" content="Pregota Collections â€” Investor Deck">
<meta property="og:description" content="Zero-reconciliation welfare contributions for Kenyan groups. KES 35â€“60B flows through informal welfare collections in Kenya every year.">
<style>
...
<section class="slide" id="cover" data-label="Cover">
    ...
    <div class="cover-badge">ðŸ‡°ðŸ‡ª Built for Kenya Â· Seed Round 2026</div>
...
<section class="slide" id="problem" data-label="Problem Depth">
    ...
    <div class="problem-grid">
        <div class="problem-card">
            <h3>â±ï¸ The Burden</h3>
            <p>4â€“8 hours per collection. Manual reconciliation of every M-Pesa message. Chasing non-payers without embarrassing anyone. Holding money that isn't theirs. Answering "nimesend, umeona?" at midnight.</p>
        </div>
        <div class="problem-card">
            <h3>ðŸ¤ The Trust Collapse</h3>
            <p>When money passes through a person, disputes happen. Accusations happen. "Sijawahi kupokea ya Kamau." Friendships end. Groups dissolve. The institution of mutual aid â€” built over decades â€” is undermined by a coordination problem.</p>
        </div>
        <div class="problem-card">
            <h3>ðŸ“Š The Scale</h3>
            <p>Kenya: 300,000+ registered chamas. ~1,000 deaths/day. ~800 weddings/day. 230,000â€“500,000 active welfare WhatsApp groups. <strong style="color:#fca5a5">KES 35â€“60 billion</strong> flows through informal welfare collections annually.</p>
        </div>
    </div>
</section>
...
<section class="slide" id="solution" data-label="Solution">
    ...
    <div class="steps">
        ...
        <div class="step"><div class="step-n">2</div><div class="step-body"><h3>Gets a shareable link</h3><p>pregota.com/c/grace-wanjiku-welfare-abcd â€” pastes it in the WhatsApp group.</p></div></div>
        ...
        <div class="step step-final"><div class="step-n">5</div><div class="step-body"><h3>Kamau clicks "Pay Out" â€” done.</h3><p>KES goes directly to Grace's M-Pesa via B2C. Kamau's job is over. He never held a shilling.</p></div></div>
    </div>
</section>
...
<section class="slide" id="market" data-label="Market Size">
    ...
    <p style="margin-top:28px;font-size:14px;color:rgba(255,255,255,.6)">Bottom-up: 230,000 groups Ã— 8 occasions/yr Ã— 15 contributors Ã— KES 30 fee = KES 83M at 10% penetration</p>
</section>

<!-- â”€â”€ 06 UNIT ECONOMICS â”€â”€ -->
<section class="slide" id="economics" data-label="Unit Economics">
    ...
    <p style="margin-top:24px;font-size:14px">Why flat fee beats percentage: <strong>Mchanga charges ~4.5%</strong> â€” on a KES 50,000 collection that's KES 2,250 from the recipient's money. Pregota charges the <strong>contributor</strong> a flat KES 30. <strong>The recipient gets 100% of what was pledged.</strong></p>
</section>
...
<section class="slide" id="traction" data-label="Traction">
    ...
    <div class="stats-row" style="max-width:700px">
        <div class="stat-box"><div class="num">23</div><div class="lbl">Welfare coordinators interviewed â€” 100% described the reconciliation problem unprompted</div></div>
        <div class="stat-box"><div class="num">Live</div><div class="lbl">M-Pesa Daraja integration â€” STK Push, callbacks, B2C payout all running in production</div></div>
    ...
    <p style="margin-top:24px">The tip module is already handling real M-Pesa transactions â€” proving the payment rail works. Collections uses the identical infrastructure.</p>
</section>
...
<section class="slide" id="growth" data-label="Growth Mechanic">
    ...
    <div class="steps" style="margin-top:28px">
        <div class="step"><div class="step-n">â†’</div><div class="step-body"><h3>Kamau shares a link in a WhatsApp group of 40</h3><p>30 people open it to contribute.</p></div></div>
        <div class="step"><div class="step-n">â†’</div><div class="step-body"><h3>All 30 experience the product</h3><p>They see the interface, the live wall, the real-time total. No pitch needed.</p></div></div>
        <div class="step"><div class="step-n">â†’</div><div class="step-body"><h3>Next time their group needs to collect</h3><p>Someone in those 30 remembers. <strong>One collection = 30 people acquired.</strong></p></div></div>
        <div class="step"><div class="step-n">â†’</div><div class="step-body"><h3>Groups overlap</h3><p>Kamau is in his office welfare group, church choir, and old-school class group. One win propagates across all three. The network compounds.</p></div></div>
    </div>
...
<section class="slide" id="competition" data-label="Competition">
    ...
    <table class="deck-table">
        ...
        <tr><td>Money goes direct to recipient</td><td class="check">âœ“</td><td class="cross">âœ—</td><td class="cross">âœ—</td><td class="cross">âœ—</td></tr>
        <tr><td>Zero coordinator reconciliation</td><td class="check">âœ“</td><td class="cross">âœ—</td><td class="cross">âœ—</td><td class="cross">âœ—</td></tr>
        <tr><td>No contributor account needed</td><td class="check">âœ“</td><td class="check">âœ“</td><td class="check">âœ“</td><td class="check">âœ“</td></tr>
        <tr><td>Live contributor wall</td><td class="check">âœ“</td><td class="check">âœ“</td><td class="cross">âœ—</td><td class="cross">âœ—</td></tr>
        <tr><td>STK Push (no app needed)</td><td class="check">âœ“</td><td class="cross">âœ—</td><td class="check">âœ“</td><td class="check">âœ“</td></tr>
        <tr><td>Recipient phone stays private</td><td class="check">âœ“</td><td class="cross">âœ—</td><td class="cross">âœ—</td><td class="cross">âœ—</td></tr>
        <tr><td>Flat predictable fee</td><td class="check">âœ“</td><td class="cross">âœ— (4.5%)</td><td class="cross">âœ—</td><td class="cross">âœ—</td></tr>
    </table>
    </div>
</section>
...
<section class="slide" id="platform" data-label="Platform">
    ...
    <div class="modules">
        <div class="module-card"><div class="icon">ðŸŽ</div><h3>Gift Vouchers</h3><p>Send KES as a redeemable code. Recipient claims to any M-Pesa.</p><div class="fee">KES 75 / gift</div></div>
        <div class="module-card"><div class="icon">âš¡</div><h3>Direct Gift</h3><p>Send anonymously to any M-Pesa. Recipient number encrypted, deleted after payout.</p><div class="fee">KES 75 / gift</div></div>
        <div class="module-card"><div class="icon">ðŸ’¸</div><h3>Staff Tips</h3><p>Tip service workers without knowing their number. Privacy by design.</p><div class="fee">KES 15 / tip</div></div>
        <div class="module-card"><div class="icon">ðŸŽ¨</div><h3>Creator Tips</h3><p>Fan tips for content creators. Kenyan Ko-fi.</p><div class="fee">KES 25 / tip</div></div>
        <div class="module-card"><div class="icon">ðŸ¤</div><h3>Collections</h3><p>Welfare group contributions. Direct to recipient. Zero reconciliation.</p><div class="fee">KES 30 / contribution</div></div>
        <div class="module-card"><div class="icon">ðŸ“Š</div><h3>Business SaaS</h3><p>Analytics + fee waiver for subscribed businesses.</p><div class="fee">KES 1,500â€“7,000 / mo</div></div>
    </div>
...
<section class="slide" id="roadmap" data-label="Roadmap">
    ...
    <div class="roadmap">
        <div class="phase active">
            <div class="phase-tag">Phase 1 â€” Now Â· Live</div>
        ...
        <div class="phase">
            <div class="phase-tag">Phase 2 â€” Q3 2026</div>
        ...
        <div class="phase">
            <div class="phase-tag">Phase 3 â€” Q4 2026</div>
...
<section class="slide" id="ask" data-label="The Ask">
    ...
    <div class="fund-grid">
        <div class="fund-card">
            <h3>Use of Funds</h3>
            <div class="fund-item"><span>Engineering (2 senior devs, 12 mo)</span><span class="pct">45% Â· KES 6.75M</span></div>
            <div class="fund-item"><span>Safaricom Daraja Go-Live & compliance</span><span class="pct">15% Â· KES 2.25M</span></div>
            <div class="fund-item"><span>Community activation (10 pilot companies)</span><span class="pct">20% Â· KES 3.0M</span></div>
            <div class="fund-item"><span>Legal, compliance, data protection</span><span class="pct">10% Â· KES 1.5M</span></div>
            <div class="fund-item"><span>Infrastructure & operations</span><span class="pct">10% Â· KES 1.5M</span></div>
        </div>
        <div class="fund-card">
            <h3>18-Month Targets</h3>
            <div class="fund-item"><span>Active welfare groups</span><span class="pct">5,000</span></div>
            <div class="fund-item"><span>Daily transactions</span><span class="pct">8,000â€“12,000</span></div>
            <div class="fund-item"><span>Monthly revenue</span><span class="pct">KES 7â€“10M</span></div>
...
<section class="slide" id="closing" data-label="Closing">
    ...
    <p style="margin-top:16px;max-width:560px">We are not building a feature. We are ending a weekly source of stress and suspicion for millions of Kenyans. The technology is built. The integration works. The market is already doing this â€” manually â€” asking for a better way.</p>
    <p style="margin-top:20px;font-size:18px;color:#fff;font-weight:700;max-width:none"><em>Pregota is that better way.</em></p>
    <div class="contact">pregota.com &nbsp;Â·&nbsp; <a href="mailto:hello@pregota.com">hello@pregota.com</a></div>
</section>
