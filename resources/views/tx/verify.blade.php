...
body{font-family:'Segoe UI',system-ui,sans-serif;background:#0f0f1a;color:#fff;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px}
.logo{font-size:20px;font-weight:900;background:linear-gradient(135deg,#c084fc,#f472b6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;text-decoration:none;margin-bottom:32px}
...
.verified-sub{text-align:center;font-size:13px;color:rgba(255,255,255,.4);margin-bottom:24px}
.type-badge{display:inline-flex;align-items:center;gap:6px;padding:4px 12px;border-radius:20px;background:rgba(124,58,237,.15);border:1px solid rgba(124,58,237,.3);font-size:11px;color:#c084fc;font-weight:700;margin-bottom:20px}
...
.hash-lbl{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:rgba(255,255,255,.3);margin-bottom:8px}
.hash-val{font-family:monospace;font-size:11px;color:rgba(255,255,255,.45);word-break:break-all;line-height:1.6}
.copy-hash{margin-top:10px;width:100%;padding:9px;border-radius:8px;background:rgba(124,58,237,.1);border:1px solid rgba(124,58,237,.2);color:#c084fc;font-size:12px;font-weight:700;cursor:pointer}
.copy-hash:hover{background:rgba(124,58,237,.18)}
.footer-note{text-align:center;font-size:11px;color:rgba(255,255,255,.2);margin-top:20px;line-height:1.6}
.home-link{display:block;text-align:center;margin-top:16px;font-size:13px;color:rgba(124,58,237,.7);text-decoration:none}
