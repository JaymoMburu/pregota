...
.biz-name{font-size:13px;color:rgba(255,255,255,.72);margin-bottom:8px}
.plan-name{font-size:22px;font-weight:900;margin-bottom:10px}
.plan-desc{font-size:13px;color:rgba(255,255,255,.78);line-height:1.55;margin-bottom:16px}
...
.price-freq{font-size:14px;color:rgba(255,255,255,.72)}
...
.next-due{font-size:13px;color:rgba(255,255,255,.72);margin-top:8px}
</style>
</head>
<body>
<nav class="nav">
...
<div class="wrap">
    ...
    <div class="confirmed-state" id="confirmed-state">
        ...
        <div style="font-size:13px;color:rgba(255,255,255,.72);margin-bottom:8px">{{ $plan->payLink->business_name }}</div>
