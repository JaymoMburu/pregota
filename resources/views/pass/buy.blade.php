...
.nav-back{font-size:13px;color:rgba(255,255,255,.45);text-decoration:none}
...
.hero p{font-size:14px;color:rgba(255,255,255,.55);line-height:1.7;max-width:380px;margin:0 auto}
...
.active-sub{font-size:12px;color:rgba(255,255,255,.45);margin-top:2px}
...
.buy-label{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.35);margin-bottom:14px}
...
.compare-title{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.3);margin-bottom:14px}
...
.compare-row span:first-child{color:rgba(255,255,255,.55)}
...
<div class="wrap">
    ...
    <div class="buy-section">
        ...
        <div class="pending-state" id="pending-state">
            ...
            <div style="font-size:13px;color:rgba(255,255,255,.45)">Enter your PIN to activate your pass</div>
        </div>
