...
.browse-link{display:block;text-align:center;margin-top:18px;font-size:13px;color:rgba(255,255,255,.65);text-decoration:none}
...
<div class="card">
    ...
    <div class="pending" id="pending-view">
        ...
        <div style="font-size:13px;color:rgba(255,255,255,.72)">Enter your M-Pesa PIN to verify and access your dashboard.</div>
    </div>
