...
.page-sub{font-size:13px;color:rgba(255,255,255,.4);margin-bottom:28px}
...
.filter-btn{padding:7px 14px;border-radius:8px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:rgba(255,255,255,.5);font-size:12px;font-weight:600;cursor:pointer}
...
.leads-table th{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:rgba(255,255,255,.35);padding:0 12px 10px;text-align:left}
...
.date-cell{color:rgba(255,255,255,.35);font-size:12px;white-space:nowrap}
        ...
        <tbody id="leadsBody">
            ...
            <tr data-date="{{ $optIn->created_at->toDateString() }}"
                ...
                <td class="venue-cell">
                    ...
                    <span style="color:rgba(255,255,255,.35)"> · {{ $optIn->billSplit->label }}</span>
                    @endif
                </td>
                <td style="color:rgba(255,255,255,.45)">{{ $optIn->billSplit->tip_handle ?? '—' }}</td>
