...
.sub{font-size:13px;color:rgba(255,255,255,.78);margin-bottom:28px;line-height:1.55}
...
.rc-ref{font-size:12px;font-family:monospace;color:rgba(255,255,255,.72);margin-top:3px}
...
.already-sub{font-size:13px;color:rgba(255,255,255,.78);line-height:1.55}

.back{display:block;text-align:center;margin-top:20px;font-size:13px;color:rgba(255,255,255,.72);text-decoration:none}
