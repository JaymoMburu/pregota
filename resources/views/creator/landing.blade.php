...
.logo{font-size:20px;font-weight:900;background:linear-gradient(135deg,#c084fc,#f472b6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;text-decoration:none}
...
.creator-badge{display:inline-flex;align-items:center;gap:7px;background:rgba(244,114,182,.1);border:1px solid rgba(244,114,182,.25);border-radius:20px;padding:6px 16px;font-size:12px;font-weight:700;color:#f472b6;margin-bottom:24px;letter-spacing:.05em}
...
.preview-url{display:inline-flex;align-items:center;gap:10px;background:rgba(124,58,237,.12);border:1px solid rgba(124,58,237,.25);border-radius:12px;padding:10px 20px;font-size:14px;font-weight:700;color:#c084fc;margin-bottom:24px;font-family:monospace}
...
.preview-avatar{width:72px;height:72px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#db2777);display:flex;align-items:center;justify-content:center;font-size:32px;margin-bottom:14px}
...
.preview-amount{background:rgba(124,58,237,.15);border:1px solid rgba(124,58,237,.3);border-radius:8px;padding:8px 16px;font-size:13px;font-weight:700;color:#c084fc;cursor:pointer}
.preview-amount.active{background:linear-gradient(135deg,#7c3aed,#db2777);border-color:transparent;color:#fff}
.preview-btn{width:100%;background:linear-gradient(135deg,#7c3aed,#db2777);border:none;border-radius:10px;padding:13px;font-size:14px;font-weight:700;color:#fff;cursor:pointer;text-align:center}
.preview-label{position:absolute;top:-12px;right:16px;background:#f472b6;color:#fff;font-size:10px;font-weight:700;padding:3px 10px;border-radius:20px;letter-spacing:.05em}
...
/* Earnings */
.earnings{background:rgba(244,114,182,.04);border-top:1px solid rgba(244,114,182,.1);border-bottom:1px solid rgba(244,114,182,.1);padding:56px 24px}
...
.e-title{font-size:14px;font-weight:700;color:#f472b6;margin-bottom:4px}
.e-text{font-size:13px;color:rgba(255,255,255,.45);line-height:1.6}

/* Fee breakdown */
.fee-box{background:rgba(124,58,237,.08);border:1px solid rgba(124,58,237,.2);border-radius:14px;padding:20px;margin-top:24px}
...
.fee-row:last-child{border-bottom:none;font-weight:700;color:#c084fc}
        ...
        <div class="steps">
            <div class="step">
                ...
                <div class="step-body">
                    ...
                    <p>Sign up with your name, handle, and a short bio about your content. Add your M-Pesa number privately — it's never shown to fans. You get your link instantly: <strong style="color:#c084fc">pregota.com/c/yourhandle</strong></p>
                </div>
            </div>
            <div class="step">
...
<div class="cta-bottom">
    <h2>Your creativity deserves<br><em style="font-style:normal;background:linear-gradient(135deg,#c084fc,#f472b6);-webkit-background-clip:text;-webkit-text-fill-color:transparent">to be paid.</em></h2>
