...
.dash-link{font-size:12px;color:rgba(255,255,255,.35);text-decoration:none}
...
/* Phase labels */
.phase-label{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:rgba(255,255,255,.35);margin-bottom:20px}
...
.amount-hint{font-size:13px;color:rgba(255,255,255,.35);margin-bottom:28px;min-height:20px}
...
.key.del{color:rgba(255,255,255,.5)}
...
.btn-reset{width:100%;padding:12px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.5);font-size:14px;font-weight:700;border-radius:12px;cursor:pointer}
...
.locked-fee{font-size:13px;color:rgba(255,255,255,.35);margin-top:4px}

/* Phone input */
.phone-wrap{margin-bottom:20px;text-align:left}
.phone-label{display:block;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:rgba(255,255,255,.4);margin-bottom:8px}
...
.phone-hint{font-size:12px;color:rgba(255,255,255,.3);text-align:center;margin-top:7px}
...
.pending-sub{font-size:13px;color:rgba(255,255,255,.45);line-height:1.55}
...
.confirmed-receipt{font-size:13px;color:rgba(255,255,255,.35);margin-bottom:6px}
.receipt-link{font-size:13px;color:#a78bfa;font-family:monospace}
.countdown{font-size:12px;color:rgba(255,255,255,.3);margin-top:18px}
